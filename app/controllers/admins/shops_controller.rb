class Admins::ShopsController < Admins::ApplicationController
  ...
  def shop_params
    params.require(:shop).permit(:name, :postcode, :address, :access, :business_time, :phone_number, :counter_seat, :table_seat, :site_name, :gourmet_site_link, :city_name, :shop_image,:shop_image_cache, :prefecture_id)
  end
