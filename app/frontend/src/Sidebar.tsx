...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen }) => {
  console.log(`[Sidebar]isSidebarOpenの値は${isSidebarOpen}です。`);
  return (
    <nav id="sidebar" className={`col-md-3 col-lg-2 bg-light sidebar `} style={{display: isSidebarOpen ? 'block' : 'none'}}>
          ...
          <li className="mb-1">
            ...
            <div className="collapse show" id="home-collapse">
              <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <li><a href="#" className="link-body-emphasis d-inline-flex text-decoration-none rounded text-white">更新</a></li>
