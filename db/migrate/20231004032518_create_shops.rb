class CreateShops < ActiveRecord::Migration[7.0]
  def change
    create_table :shops do |t|
      ...
      t.text :access, default: "", null: false,                               comment: "店舗へのアクセス"
      t.text :business_time, default: "", null: false,                        comment: "店舗の営業時間"
      ...
      t.text :gourmet_site_link, default: "", null: false,                    comment: "店舗のグルメサイトのリンク"
